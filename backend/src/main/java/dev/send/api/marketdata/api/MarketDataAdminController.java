...
public class MarketDataAdminController {
    ...
    @PostMapping("/tickers")
    public List<TrackedTickerJdbcRepository.TrackedTicker> addTicker(@RequestParam("symbol") String symbol) {
    ...
    public List<TrackedTickerJdbcRepository.TrackedTicker> disableTicker(@PathVariable String symbol) {
