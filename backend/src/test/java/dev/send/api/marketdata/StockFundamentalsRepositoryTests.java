...
class StockFundamentalsRepositoryTests {
    ...
    void saveReusesPrimaryKeyForFundamentalsUpsert() {
        stockFundamentalsRepository.saveAndFlush(new StockFundamentalsEntity(
                "AAPL",
                6.12,
                18.2,
                1.04,
        ...
        StockFundamentalsEntity entity =
                stockFundamentalsRepository.findById("AAPL").orElseThrow();
